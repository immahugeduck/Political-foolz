...
import { BarChart3, TrendingUp, CheckCircle2, XCircle, Info, RefreshCw, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Detailed voting tallies and bipartisan split rates for June 2026</p>
        </div>
              ...
              <div className="p-4 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1.5">
                  {isPassed ? (
                    ...
                    <span className="inline-flex items-center text-xs font-bold text-red-650 bg-red-50/70 px-2 py-0.5 rounded border border-red-105">
